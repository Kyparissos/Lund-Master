...
Omega_in.signals.values = linspace(1500,2000,length(Omega_in.time))'*ones(1,4) %You will need to change ones to something better, HINT linspace
%%
disp('starting sim')
...
dat1 = iddata(out.acc.data(:,3)+g,4*out.Omega.data(:,1).^1,inner_h);
