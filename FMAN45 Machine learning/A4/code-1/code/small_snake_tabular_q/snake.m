...
rewards = struct('default', 0, 'apple', 100, 'death', -100); % Reward signal
gamm    = 0.9;  % Discount factor in Q-learning
alph    = 0.5; % Learning rate in Q-learning (automatically set to zero during testing)
eps     = 0.025; % Random action selection probability in epsilon-greedy Q-learning (automatically set to zero during testing)
