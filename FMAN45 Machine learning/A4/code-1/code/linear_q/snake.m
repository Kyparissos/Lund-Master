...
% STATE-ACTION FEATURES (SEE EXERCISE 7).
%
...
rewards   = struct('default',-1, 'apple', 10, 'death', -10); % Experiment with different reward signals, to see which yield a good behaviour for the agent
gamm      = 0.5;                                          % Discount factor in Q-learning
...
for i = 1 : nbr_ep
    ...
    while 1
        ...
        if rem(i, show_every_kth) == 0
            imagesc(grid_show); title(['Current score: ' num2str(score)]); axis equal;
        end
