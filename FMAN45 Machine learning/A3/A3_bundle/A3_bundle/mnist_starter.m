function mnist_starter()
    ...
    z_train = loadMNISTLabels('data/mnist/train-labels.idx1-ubyte');
    ...
    % correct sizes
    [~, ~] = evaluate(net, x_train(:,:,:,1:8), z_train(1:8), true);
    ...
    net = training(net, x_train, z_train, x_val, z_val, training_opts);
